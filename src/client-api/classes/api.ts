...
export const ContractControllerApiFetchParamCreator = function(configuration?: Configuration) {
  return {
    ...
    exportContractUsingGET(
      ...
      if (descOrAsc2 !== undefined) {
        localVarQueryParameter["descOrAsc"] = descOrAsc2;
      }
  ...
  return {
    ...
    queryExperimentByConditionUsingPOST(request: GetQuotationExperimentByConditonReq, options: any = {}): FetchArgs {
      ...
      if (request === null || request === undefined) {
        throw new RequiredError(
          "request",
          "Required parameter request was null or undefined when calling queryExperimentByConditionUsingPOST."
        );
      }
...
export const QuotationExperimentControllerApiFp = function(configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    queryExperimentByConditionUsingPOST(
      request: GetQuotationExperimentByConditonReq,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ResultQuotationExperimentEntity> {
      const localVarFetchArgs = QuotationExperimentControllerApiFetchParamCreator(configuration).queryExperimentByConditionUsingPOST(
        request,
        options
      );
      return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
...
export class QuotationExperimentControllerApi extends BaseAPI {
  ...
  public queryExperimentByConditionUsingPOST(request: GetQuotationExperimentByConditonReq, options?: any) {
    return QuotationExperimentControllerApiFp(this.configuration).queryExperimentByConditionUsingPOST(request, options)(
      this.fetch,
      this.basePath
    );
  }
