...
import {contractApi,proceedsnApi, GetContractReceivablesResp, GetContractResp} from '../../client/data-provider'
    ...
    deleteItem(item : GetContractReceivablesResp){
        this.$confirm('是否删除该收款项, 是否继续?', '提示', {
          ...
          type: 'warning'
            ...
            let result = proceedsnApi.deleteContractReceivablesUsingPOST(item.id!);
            result.then(r =>{
