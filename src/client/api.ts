...
export const ContractControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getContractInvoiceUsingGET(customerId: number, options: any = {}): FetchArgs {
            // verify required parameter 'customerId' is not null or undefined
            if (customerId === null || customerId === undefined) {
                throw new RequiredError('customerId','Required parameter customerId was null or undefined when calling getContractInvoiceUsingGET.');
            }
         ...
         * @throws {RequiredError}
         */
        getContractPeriodUsingGET(customerId: number, options: any = {}): FetchArgs {
            // verify required parameter 'customerId' is not null or undefined
            if (customerId === null || customerId === undefined) {
                throw new RequiredError('customerId','Required parameter customerId was null or undefined when calling getContractPeriodUsingGET.');
            }
         ...
         * @throws {RequiredError}
         */
        getContractReceivablesUsingGET(customerId: number, options: any = {}): FetchArgs {
            // verify required parameter 'customerId' is not null or undefined
            if (customerId === null || customerId === undefined) {
                throw new RequiredError('customerId','Required parameter customerId was null or undefined when calling getContractReceivablesUsingGET.');
            }
...
export const ContractControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getContractInvoiceUsingGET(customerId: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ResultListGetContractInvoiceResp> {
            const localVarFetchArgs = ContractControllerApiFetchParamCreator(configuration).getContractInvoiceUsingGET(customerId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getContractPeriodUsingGET(customerId: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ResultListGetCustomerFollowResp> {
            const localVarFetchArgs = ContractControllerApiFetchParamCreator(configuration).getContractPeriodUsingGET(customerId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getContractReceivablesUsingGET(customerId: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ResultListGetContractReceivablesResp> {
            const localVarFetchArgs = ContractControllerApiFetchParamCreator(configuration).getContractReceivablesUsingGET(customerId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ContractControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getContractInvoiceUsingGET(customerId: number, options?: any) {
            return ContractControllerApiFp(configuration).getContractInvoiceUsingGET(customerId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary 获取合同的期间信息
         ...
         * @throws {RequiredError}
         */
        getContractPeriodUsingGET(customerId: number, options?: any) {
            return ContractControllerApiFp(configuration).getContractPeriodUsingGET(customerId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary 获取合同的收款信息
         ...
         * @throws {RequiredError}
         */
        getContractReceivablesUsingGET(customerId: number, options?: any) {
            return ContractControllerApiFp(configuration).getContractReceivablesUsingGET(customerId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary 获取合同列表
...
export class ContractControllerApi extends BaseAPI {
     ...
     * @memberof ContractControllerApi
     */
    public getContractInvoiceUsingGET(customerId: number, options?: any) {
        return ContractControllerApiFp(this.configuration).getContractInvoiceUsingGET(customerId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ContractControllerApi
     */
    public getContractPeriodUsingGET(customerId: number, options?: any) {
        return ContractControllerApiFp(this.configuration).getContractPeriodUsingGET(customerId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ContractControllerApi
     */
    public getContractReceivablesUsingGET(customerId: number, options?: any) {
        return ContractControllerApiFp(this.configuration).getContractReceivablesUsingGET(customerId, options)(this.fetch, this.basePath);
    }
