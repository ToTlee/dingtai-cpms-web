...
export const ContractControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listContractUsingGET(pageCurrent?: number, pageSize?: number, orderBy?: string, descOrAsc?: string, pageBegin?: number, contractNo?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ResultPageInfoGetCustomerListResp> {
