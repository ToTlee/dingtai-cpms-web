 ...
 *
 * @export
 * @interface PageInfoGetProjectCategoryListResp
 */
export interface PageInfoGetProjectCategoryListResp {
  /**
   *
   * @type {number}
   * @memberof PageInfoGetProjectCategoryListResp
   */
  endRow?: number;
  /**
   *
  ...
  /**
   *
   * @type {Array<GetProjectCategoryListResp>}
   * @memberof PageInfoGetProjectCategoryListResp
   */
  list?: Array<GetProjectCategoryListResp>;
  /**
   *
   * @type {number}
   * @memberof PageInfoGetProjectCategoryListResp
 ...
 *
 * @export
 * @interface ResultPageInfoGetProjectCategoryListResp
 */
export interface ResultPageInfoGetProjectCategoryListResp {
  /**
   *
   * @type {PageInfoGetProjectCategoryListResp}
   * @memberof ResultPageInfoGetProjectCategoryListResp
   */
  data?: PageInfoGetProjectCategoryListResp;
  /**
   *
   * @type {string}
   * @memberof ResultPageInfoGetProjectCategoryListResp
...
export const ProjectQuotationControllerApiFp = function (configuration?: Configuration) {
  return {
    ...
    getProjectQuotationInfoUsingGET(
      projectName: string,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ResultListGetProjectQuotationListResp> {
      const localVarFetchArgs = ProjectQuotationControllerApiFetchParamCreator(configuration).getProjectQuotationInfoUsingGET(
        projectName,
        options
      );
      return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
    ...
    queryAllProjectQuotationUsingGET(
      ...
      pageBegin?: number,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ResultPageInfoGetProjectQuotationListResp> {
      const localVarFetchArgs = ProjectQuotationControllerApiFetchParamCreator(configuration).queryAllProjectQuotationUsingGET(
        pageCurrent,
        pageSize,
        orderBy,
        descOrAsc,
...
export const ProjectQuotationControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
  return {
    ...
    queryAllProjectQuotationUsingGET(
      ...
      return ProjectQuotationControllerApiFp(configuration).queryAllProjectQuotationUsingGET(
        pageCurrent,
        pageSize,
        orderBy,
        descOrAsc,
...
export class ProjectQuotationControllerApi extends BaseAPI {
  ...
  public getProjectQuotationInfoUsingGET(projectName: string, options?: any) {
    return ProjectQuotationControllerApiFp(this.configuration).getProjectQuotationInfoUsingGET(projectName, options)(
      this.fetch,
      this.basePath
    );
  }
  ...
  public queryAllProjectQuotationUsingGET(
    ...
    return ProjectQuotationControllerApiFp(this.configuration).queryAllProjectQuotationUsingGET(
      pageCurrent,
      pageSize,
      orderBy,
      descOrAsc,
...
export const QuotationCategoryControllerApiFp = function (configuration?: Configuration) {
  return {
    ...
    getProjectCategoryUsingGET(
      ...
      pageBegin?: number,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ResultPageInfoGetProjectCategoryListResp> {
