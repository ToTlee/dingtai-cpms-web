...
export const ProjectControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        addProjectUsingPOST(request: AddProjectReq, options: any = {}): FetchArgs {
            // verify required parameter 'request' is not null or undefined
            if (request === null || request === undefined) {
                throw new RequiredError('request','Required parameter request was null or undefined when calling addProjectUsingPOST.');
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"AddProjectReq" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(request || {}) : (request || "");
...
export const ProjectControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addProjectUsingPOST(request: AddProjectReq, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Result> {
            const localVarFetchArgs = ProjectControllerApiFetchParamCreator(configuration).addProjectUsingPOST(request, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ProjectControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        addProjectUsingPOST(request: AddProjectReq, options?: any) {
            return ProjectControllerApiFp(configuration).addProjectUsingPOST(request, options)(fetch, basePath);
        },
        /**
         * 
         * @summary 根据项目名称获取项目信息
...
export class ProjectControllerApi extends BaseAPI {
    ...
    public addProjectUsingPOST(request: AddProjectReq, options?: any) {
        return ProjectControllerApiFp(this.configuration).addProjectUsingPOST(request, options)(this.fetch, this.basePath);
    }
...
export const ProjectQuotationControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        queryAllProjectQuotationUsingGET(pageCurrent?: number, pageSize?: number, orderBy?: string, descOrAsc?: string, pageBegin?: number, options: any = {}): FetchArgs {
...
export const ProjectQuotationControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProjectQuotationInfoUsingGET(projectName: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ResultListGetProjectQuotationListResp> {
         ...
         * @throws {RequiredError}
         */
        queryAllProjectQuotationUsingGET(pageCurrent?: number, pageSize?: number, orderBy?: string, descOrAsc?: string, pageBegin?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ResultPageInfoGetProjectQuotationListResp> {
            const localVarFetchArgs = ProjectQuotationControllerApiFetchParamCreator(configuration).queryAllProjectQuotationUsingGET(pageCurrent, pageSize, orderBy, descOrAsc, pageBegin, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ProjectQuotationControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        queryAllProjectQuotationUsingGET(pageCurrent?: number, pageSize?: number, orderBy?: string, descOrAsc?: string, pageBegin?: number, options?: any) {
            return ProjectQuotationControllerApiFp(configuration).queryAllProjectQuotationUsingGET(pageCurrent, pageSize, orderBy, descOrAsc, pageBegin, options)(fetch, basePath);
        },
    };
};
...
export class ProjectQuotationControllerApi extends BaseAPI {
     ...
     * @memberof ProjectQuotationControllerApi
     */
    public queryAllProjectQuotationUsingGET(pageCurrent?: number, pageSize?: number, orderBy?: string, descOrAsc?: string, pageBegin?: number, options?: any) {
        return ProjectQuotationControllerApiFp(this.configuration).queryAllProjectQuotationUsingGET(pageCurrent, pageSize, orderBy, descOrAsc, pageBegin, options)(this.fetch, this.basePath);
    }
